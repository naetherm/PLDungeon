...
function SetState(newState)
	...
	action = {
		...
		-- Scene nodes - icons
		[1] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DebugSceneNodeIcons", "Flags", "")
		...
		[2] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DebugSceneNodeIcons", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DebugSceneNodeNames", "Flags", "")
			stateTimeout = 5					-- Wait a few seconds, then go into the next state
			return "A scene consists of nodes"	-- Return the state text
		end,
		...
		-- Wireframes
		[3] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DebugWireframes", "Flags", "")
		...
		[4] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Mode",  "ShowAlbedo")
			stateTimeout = 5						-- Wait a few seconds, then go into the next state
		...
		[5] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Mode",  "ShowAmbientOcclusion")
			stateTimeout = 5								-- Wait a few seconds, then go into the next state
		...
		[6] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Mode",  "ShowNormals")
			stateTimeout = 5									-- Wait a few seconds, then go into the next state
		...
		[7] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Mode",  "ShowDepth")
			stateTimeout = 5					-- Wait a few seconds, then go into the next state
		...
		[8] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Mode",  "ShowSpecularColor")
			stateTimeout = 5								-- Wait a few seconds, then go into the next state
		...
		[9] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Mode",  "ShowSpecularExponent")
			stateTimeout = 5								-- Wait a few seconds, then go into the next state
		...
		[10] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Mode",  "ShowSelfIllumination")
			stateTimeout = 5								-- Wait a few seconds, then go into the next state
		...
		[11] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Flags", "")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBufferDebug", "Mode",  "ShowGlow")
			stateTimeout = 5					-- Wait a few seconds, then go into the next state
		...
		-- Ambient
		[12] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredSPSSAO",			"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGlow",			"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredLighting",		"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("ForwardVolumetricFog",	"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGodRays",		"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredDepthFog",		"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredDOF",			"Flags", "Inactive")
			stateTimeout = 5	-- Wait a few seconds, then go into the next state
		...
		[14] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGlow",			"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredLighting",		"Flags", "NoShadow")
			PL.Application.SceneRendererTool.SetPassAttribute("ForwardVolumetricFog",	"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGodRays",		"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredDepthFog",		"Flags", "Inactive")
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredDOF",			"Flags", "Inactive")
		...
		[19] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBuffer", "Flags", "NoDiffuseMap|NoSpecularMap|NoNormalMap|NoDetailNormalMap|NoParallaxMapping|NoDisplacementMapping|NoAmbientOcclusionMap|NoLightMap|NoEmissiveMap|NoGlow|NoGlowMap|NoFresnelReflection|NoReflectivityMap|NoReflectionMap")
			stateTimeout = 5				-- Wait a few seconds, then go into the next state
		...
		[20] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBuffer", "Flags", "NoSpecularMap|NoNormalMap|NoDetailNormalMap|NoParallaxMapping|NoDisplacementMapping|NoAmbientOcclusionMap|NoLightMap|NoEmissiveMap|NoGlow|NoGlowMap|NoFresnelReflection|NoReflectivityMap|NoReflectionMap")
			stateTimeout = 5				-- Wait a few seconds, then go into the next state
		...
		[21] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBuffer", "Flags", "NoNormalMap|NoDetailNormalMap|NoParallaxMapping|NoDisplacementMapping|NoAmbientOcclusionMap|NoLightMap|NoEmissiveMap|NoGlow|NoGlowMap|NoFresnelReflection|NoReflectivityMap|NoReflectionMap")
			stateTimeout = 5							-- Wait a few seconds, then go into the next state
		...
		[22] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBuffer", "Flags", "NoDetailNormalMap|NoParallaxMapping|NoDisplacementMapping|NoAmbientOcclusionMap|NoLightMap|NoEmissiveMap|NoGlow|NoGlowMap|NoFresnelReflection|NoReflectivityMap|NoReflectionMap")
			stateTimeout = 5									-- Wait a few seconds, then go into the next state
		...
		[23] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBuffer", "Flags", "NoDetailNormalMap|NoAmbientOcclusionMap|NoLightMap|NoEmissiveMap|NoGlow|NoGlowMap|NoFresnelReflection|NoReflectivityMap|NoReflectionMap")
			stateTimeout = 5											-- Wait a few seconds, then go into the next state
		...
		[24] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBuffer", "Flags", "NoDetailNormalMap|NoAmbientOcclusionMap|NoFresnelReflection|NoReflectivityMap|NoReflectionMap")
			stateTimeout = 5														-- Wait a few seconds, then go into the next state
		...
		[25] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("DeferredGBuffer", "Flags", "NoDetailNormalMap|NoAmbientOcclusionMap|NoLightMap")
			stateTimeout = 5																	-- Wait a few seconds, then go into the next state
		...
		-- HDR: off
		[26] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("EndHDR", "Flags", "Inactive")
			stateTimeout = 5	-- Wait a few seconds, then go into the next state
		...
		[27] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("EndHDR", "Flags", "NoAutomaticAverageLuminance|NoLightAdaptation|NoBloom")
			stateTimeout = 5					-- Wait a few seconds, then go into the next state
		...
		[28] = function()
			PL.Application.SceneRendererTool.SetPassAttribute("EndHDR", "Flags", "NoBloom")
			stateTimeout = 5													-- Wait a few seconds, then go into the next state
