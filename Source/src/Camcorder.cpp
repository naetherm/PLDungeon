...
void Camcorder::StopRecord()
{
	...
	if (m_bRecording) {
		...
		if (pCameraSceneNode) {
			...
			SceneNodeModifier *pSceneNodeModifier = pCameraSceneNode->GetModifier("SNMPositionKeyframeRecord");
			...
			pSceneNodeModifier = pCameraSceneNode->GetModifier("SNMRotationKeyframeRecord");
			if (pSceneNodeModifier) {
			...
			pCameraSceneNode->RemoveModifier("SNMPositionKeyframeRecord");
			pCameraSceneNode->RemoveModifier("SNMRotationKeyframeRecord");
		}
	}
}
