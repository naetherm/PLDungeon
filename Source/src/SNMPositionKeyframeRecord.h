...
#ifndef __DUNGEON_SNMPOSITIONKEYFRAMERECORD_H__
#define __DUNGEON_SNMPOSITIONKEYFRAMERECORD_H__
#pragma once
...
class SNMPositionKeyframeRecord : public PLScene::SNMTransform {
	...
	//[ RTTI interface                                        ]
	//[-------------------------------------------------------]
	pl_class(pl_rtti_export, SNMPositionKeyframeRecord, "", PLScene::SNMTransform, "Keyframe position animation scene node modifier class")
		// Attributes
	...
	public:
		...
		*    Owner scene node
		*/
		SNMPositionKeyframeRecord(PLScene::SceneNode &cSceneNode);

		/**
		*  @brief
		*    Destructor
		*/
		virtual ~SNMPositionKeyframeRecord();
...
#endif // __DUNGEON_SNMPOSITIONKEYFRAMERECORD_H__
